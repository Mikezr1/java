...
/*
Challenge 18: The Replicator of D’To
...
ok 1. Make a program that creates an array of length 5.
ok 2. Ask the user for five numbers and put them in the array.
3. Make a second array of length 5.
4. Use a loop to copy the values out of the original array and into the new one.
5. Display the contents of both arrays one at a time to illustrate that the Replicator of D’To works again.
